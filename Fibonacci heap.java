...
public class FibonacciHeap {
	 ...
	 * 
	 * fix the Structure of the tree after delete min
	 * Arrange the roots in Buckets and linked Equal rank 
	 * the result is a list of nodes  sorted by ranks 
	 * only one node with each rank
	 */
	public void fixTreeStructure() {
	 ...
	 *
	 * return number of trees in child and remove parent for each child
	 */
	...
	public void decreaseKey(HeapNode x, int delta) {
		...
		if (x.key < this.minTree.key) {
			...
			//this.fixTreeStructure();
			//this.assertEverything();
			//this.assertTreesAreDifferentRanks();
		if(x.parent==null)
			return;
	 ...
	 * input two  of the same rank, and generates a tree of rank bigger by one,
	 ...
	 * 
	 * add newNode   
	 * true -add at the beginning of the list (from the left side to trees)
	 * else at the end 
	 */
